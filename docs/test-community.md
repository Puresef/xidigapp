...
| Membership       | 15 Supporters, free members, 1 admin, 2 mods, 1 verifier grant, 1 suspended, 1 deactivated, `is_ai` helpers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| Capital          | 1 submitted candidate (live 7-day Supporter vote, 2 recusal-safe mod reviews, help/cosign interests) + 1 draft candidate. **No invest intents and no gate evaluations are seeded** — investing is not offered, so seed data must not fabricate a funnel the product does not have (A2 containment)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
polls, reviewer recusal, Supporter-only candidate votes, DM pair uniqueness,
