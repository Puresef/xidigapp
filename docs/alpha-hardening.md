...
| 5 | Capital/Maal (candidates · non-financial interest) | ✅ | investing not offered — every invest path refuses (`capital_unavailable`); co-sign/help only; no money movement |
