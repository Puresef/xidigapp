...
| 5 | Capital/Maal (candidates · non-financial interest) | ✅ | investing not offered — every invest path refuses (`capital_unavailable`); Show support/help only; no money movement |
